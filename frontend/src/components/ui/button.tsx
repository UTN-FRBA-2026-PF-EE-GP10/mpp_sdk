...
const buttonVariants = cva(
  // aria-disabled deliberately does NOT get pointer-events-none like
  // disabled: does - a button using aria-disabled (instead of the native
  // `disabled` attribute) needs to stay hoverable/focusable so its
  // `title` explaining *why* stays reachable. See CurveDashboardPane's
  // Remeasure/Delete buttons and button.tsx's own note on this.
